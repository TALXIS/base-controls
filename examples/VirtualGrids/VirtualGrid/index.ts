...
import { Grid } from '../../../dist/components/Grid/Grid';
import { IGrid, IGridParameters } from "../../../dist/components/Grid/interfaces";
import * as ReactDOM from 'react-dom';
import * as React from 'react';
import { Dataset } from "./Dataset";

export class VirtualGrid implements ComponentFramework.StandardControl<IInputs, IOutputs> {
   ...
   private _dataset: Dataset;
    ...
    {   
        this._dataset = new Dataset(context);
    ...
    {
        //inject for local harness
        context.factory.requestRender = () => this.updateView(context);
