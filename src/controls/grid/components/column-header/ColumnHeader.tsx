import { IGridColumnHeaderParams } from "./root/ColumnHeaderRoot";
import { ColumnHeaderContainer } from "./container/ColumnHeaderContainer";
import { IGridColumnHeaderComponents } from "./components";
 ...
 */
export interface IGridColumnHeaderOptions {
    /** The seed the header's theme is generated from, in place of the grid's own. */
    theme?: ITheme;
    components?: IGridColumnHeaderComponents;
}

export interface IGridColumnHeaderProps extends IGridColumnHeaderParams, IGridColumnHeaderOptions { }
 ...
 */
export const ColumnHeader = (props: IGridColumnHeaderProps) => {
