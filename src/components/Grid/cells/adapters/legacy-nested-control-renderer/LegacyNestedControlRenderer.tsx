    ...
    return <NestedControlRenderer
        ...
        onOverrideComponentProps={(componentProps: INestedControlRendererComponentProps) => ({
            ...
            onOverrideUnmount: (control, defaultUnmount) => {
                //unmounting a nested PCF in Power Apps re-initializes the others, which flickers - they are
                //unmounted when the grid is destroyed instead. The react component can still be torn down
