  ...
  <tabs>
    <tab verticallayout="true" id="{10000000-0000-0000-0000-000000000001}" IsUserDefined="1" name="OverviewTab" locklevel="0" expanded="true" showlabel="true">
      ...
      <columns>
        <column width="100%">
          <sections>
            <section name="primarySection" showlabel="true" showbar="false" locklevel="0" id="{10000000-0000-0000-0000-000000000002}" IsUserDefined="1" layout="varwidth" columns="1" labelwidth="115" celllabelalignment="Left" celllabelposition="Top">
              <labels>
              ...
              <rows>
                ...
                <row>
                  <cell id="{10000000-0000-0000-0000-000000000005}" showlabel="true" locklevel="0">
                ...
                <row>
                  <cell id="{10000000-0000-0000-0000-000000000006}" showlabel="true" locklevel="0">
      ...
      <columns>
        <column width="100%">
          <sections>
            ...
            <section name="selectionSection" showlabel="true" showbar="false" locklevel="0" id="{10000000-0000-0000-0000-000000000022}" IsUserDefined="1" layout="varwidth" columns="1" labelwidth="115" celllabelalignment="Left" celllabelposition="Top">
              <labels>
              ...
              <rows>
                ...
                <row>
                  <cell id="{10000000-0000-0000-0000-000000000024}" showlabel="true" locklevel="0">
                    <labels><label description="Two options colorful" languagecode="1033" /></labels>
      ...
      <columns>
        <column width="100%">
          <sections>
            ...
            <section name="attachmentsSection" showlabel="true" showbar="false" locklevel="0" id="{10000000-0000-0000-0000-000000000029}" IsUserDefined="1" layout="varwidth" columns="1" labelwidth="115" celllabelalignment="Left" celllabelposition="Top">
              <labels>
