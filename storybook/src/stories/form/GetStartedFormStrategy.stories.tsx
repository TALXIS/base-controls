...
Go to [**Get started**](?path=/story/form-get-started--overview), [**React compose Overview**](?path=/story/form-react-compose--overview), or [**Xrm Builder**](?path=/story/form-xrm--overview).
                `.trim(),
            },
        },
    },
