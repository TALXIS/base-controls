...
<Meta title="Form/React compose/Custom UI" />

<Title>Custom UI</Title>
<Subtitle>Replace selected presentation layers in the React compose model without changing the underlying form runtime.</Subtitle>
...
<Heading>Tabs overrides</Heading>
...
<div className="form-docs-copy">
  <p>
    Use <a href="./?path=/story/form-react-compose-custom-ui--custom-tabs">Form / React compose / Custom UI / Custom Tabs</a> for the horizontal tabs override and <a href="./?path=/story/form-react-compose-custom-ui--custom-tabs-vertical">Custom Tabs Vertical</a> for the same pattern with a vertical navigation layout.
  </p>
</div>
