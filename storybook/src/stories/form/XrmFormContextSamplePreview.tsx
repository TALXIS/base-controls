...
import type { IFormApi, IXrmFormContext } from "@talxis/base-controls"
...
interface IXrmFormContextSamplePreviewProps {
    docsExample: IFormContextDocsExample
}

export const XrmFormContextSamplePreview = (props: IXrmFormContextSamplePreviewProps) => {
    ...
    const [api, setApi] = React.useState<IFormApi | null>(null)
    ...
    const runCode = React.useCallback(() => {
        ...
        try {
            ...
            const executableScript = transpileExecutableScript(sourceScript, "xrm-form-context-sample.ts")
        ...
        <div className={styles.root}>
            ...
            <div className={showCode ? undefined : styles.hiddenPane}>
                <XrmComponentsCodeEditor
                    ...
                    kind="form-context"
                    language="typescript"
                    path="file:///sandbox/xrm-form-context-sample.ts"
                    readOnly={false}
                    label=""
